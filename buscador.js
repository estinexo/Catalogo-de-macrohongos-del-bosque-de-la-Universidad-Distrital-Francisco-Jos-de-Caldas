...
const ESPECIES = [
    ...
    {
        nombre: "Amanita validae",
        nombreComun: "Amanita válida",
        familia: "Amanitaceae",
        orden: "Agaricales",
        tipo: TIPO.MICORRIZICO,
        comestible: false,
    ...
    },
    {
        ...
        nombreComun: "Amanita de la muerte",
        familia: "Amanitaceae",
        orden: "Agaricales",
        tipo: TIPO.MICORRIZICO,
        comestible: false,
        toxico: true,
        imagen: "Amanitas/muscaria/muscaria_1.jpg",
        descripcion: "La seta más tóxica del mundo. Contiene amatoxinas que causan fallo hepático. Sombrero verde-oliva, láminas blancas, anillo fino.",
    },
    {
        nombre: "Amanita caesarea",
        nombreComun: "Amanita del César",
        familia: "Amanitaceae",
        orden: "Agaricales",
        tipo: TIPO.MICORRIZICO,
        comestible: true,
        ...
        descripcion: "Sombrero naranja intenso, láminas anaranjadas, anillo amarillo. Considerada una de las mejores setas comestibles.",
    },

    // --- Agaricaceae ---
    {
        nombre: "Agaricus campestris",
        nombreComun: "Champiñón de pradera",
        familia: "Agaricaceae",
        orden: "Agaricales",
        tipo: TIPO.SAPROFITO,
        comestible: true,
        ...
        descripcion: "Sombrero blanco a crema con escamas pardas, láminas rosadas que oscurecen con la edad. Comestible y muy apreciado.",
    },
    {
        nombre: "Agaricus xanthodermus",
        nombreComun: "Agaricus amarillento",
        familia: "Agaricaceae",
        orden: "Agaricales",
        tipo: TIPO.SAPROFITO,
        comestible: false,
        ...
        descripcion: "Se distingue por olor fuerte a fenol (químico). Láminas rosadas, sombrero blanco. Tóxico, causa malestar gastrointestinal.",
    },
    ...
    {
        nombre: "Lepista saeva",
        nombreComun: "Seta del roble",
        familia: "Tricholomataceae",
        orden: "Agaricales",
        tipo: TIPO.MICORRIZICO,
        comestible: true,
        ...
        descripcion: "Sombrero gris-púrpura, láminas grises, pie blanco con fibras. Micorrícica con Quercus humboldtii. Comestible.",
    },
    {
        nombre: "Tricholoma equestre",
        nombreComun: "Seta del pino",
        familia: "Tricholomataceae",
        orden: "Agaricales",
        tipo: TIPO.MICORRIZICO,
        comestible: true,
        toxico: false,
        imagen: "Agaricales/Agarical_1.jpg",
        descripcion: "Sombrero amarillo-verdoso, láminas amarillas, pie amarillo. Micorrícica con pinos. Comestible pero puede causar intoxicación en algunas personas.",
    },
    {
        nombre: "Clitocybe nebularis",
        nombreComun: "Clitocibe nebulosa",
        familia: "Tricholomataceae",
        orden: "Agaricales",
        tipo: TIPO.SAPROFITO,
        comestible: true,
        toxico: false,
        imagen: "Agaricales/Agarical_2.jpg",
        descripcion: "Sombrero gris oscuro a marrón, convexo con depresión central. Láminas decurrentes, pie corto. Comestible pero de sabor mediocre.",
    },
    ...
    // --- Cortinariaceae ---
    {
        ...
        toxico: false,
        imagen: "Agaricales/Agarical_3.jpg",
        descripcion: "Sombrero violeta intenso, láminas violetas, pie violáceo. Micorrícica con Quercus humboldtii. Comestible, muy decorativa.",
    },
    {
